...
class PeripheraInventory{
    ...
    public void viewAllAvailablePeripherals(){
        ...
        for(WorkplacePeripheral peripheral : peripheralList) {
            if(peripheral.isPAvailable()){
                System.out.println("Type: " + peripheral.getPeripheralType() + " | " + "Name: " + peripheral.getPeripheralName()
                + " | " + "Code: " + peripheral.getPeripheralCode());
            } 
    ...
    public void viewNotAvailablePeripherals(){
        ...
        for(WorkplacePeripheral peripheral : peripheralList){
            if(!peripheral.isPAvailable()){
                System.out.println("Type: " + peripheral.getPeripheralType() + " | " + "Name: " + peripheral.getPeripheralName()
                + " | " + "Code: " + peripheral.getPeripheralCode() + " | " + "Employee: " + peripheral.getEmployeePeripheral());
                 System.out.println("_______________________________________________________________________________________");
            }
        }
    ...
    public void viewAllInputPeripherals(){
         ...
         for(WorkplacePeripheral peripheral : peripheralList){
            if(peripheral.getPeripheralType().equals("input")){
                System.out.println("Name: " + peripheral.getPeripheralName() + " | " + "Code: " + peripheral.getPeripheralCode()
                + " | " + "Eployee: " + peripheral.getEmployeePeripheral() + " | " + "Availabilty: " + peripheral.isPAvailable());
                 System.out.println("_______________________________________________________________________________________");
            }  
         }
    }
    ...
    public static void main(String[] args) {
        ...
        while(true){
            System.out.println("_________________________________ WORKPLACE PERIPHERAL INVENTORY");
            ...
            switch(choice){
                ...
                break;
                case 12:
                System.out.println("___________________________PROGRAM CLOSED________________________");
                System.exit(0);
                break;
